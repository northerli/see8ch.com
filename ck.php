...
<div class="content-wrapper">
	...
	<section id="resume-experience">
		...
		<article>
			<h3>Mike Horn</h3>
 			<p class="position">Design // <span>Black Dog Digital - Denver, CO</span></p>
		...
		<article>
			<h3>The Outlook</h3>
 			<p class="position">Development // <span>PokaYoke- Brooklyn, NY</span></p>
			<div class="description">
				<!--<p></p>-->
				<ul class="specs work">
		...
		<article>
			<h3>Tutorgrape</h3>
 			<p class="position">Design & Development // <span>Hack4Colorado - 2013</span></p>
			<div class="description">
	...
	<section id="resume-education">
		...
		<article>
			...
			<p class="school contact"><a href="http://michaelarestad.com">michaelarestad.com</a> // <a href="mailto:marestad@gmail.com">marestad@gmail.com</a> // <a href="tel:3039815160">303-981-5160</a></p>
		</article>

		<article>
			<h3 class="degree">Michael Gyura</h3>
			<p class="school">PokaYoke // Owner</p>
			<p class="school contact"><a href="http://pokayoke.co/">pokayoke.co</a> // <a href="mailto:michael@gyura.com">michael@gyura.com</a> // <a href="tel:5073986422">507-398-6422</a></p>
		</article>
